// ملف تطبيق الصلاحيات لصفحة دفعات السائق (نسخة مبسطة)
 ...
 * @returns {boolean}
 */
function canDeletePaymentSimple(itemDate, createdAt) {
 ...
 */
function getPaymentDeleteButton(itemId, itemDate, createdAt, deleteFunction = 'deletePayment', buttonClass = 'delete-btn') {
    if (canDeletePaymentSimple(itemDate, createdAt)) {
